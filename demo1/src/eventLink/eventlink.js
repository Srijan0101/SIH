    ...
    return (
      ...
      <div className="events-wrapper">
        ...
        <div className="searchbar">
          {/* <div>
                <img class="searchlogo" src="sl.png" alt="">
            </div> */}
        ...
        <div className="first3">
          ...
          <div className="event"><img src={seminar} /></div>
          <div className="event"><img src={webinar} /></div>
        </div>
        <div className="first3">
          <div className="event"><img src={workshops} /></div>
          <div className="event"><img src={seminar} /></div>
          <div className="event"><img src={webinar} /></div>
        </div>
        {/* <div class="first3">
